...
public final class IOUtils {
	...
	public static Response http(String method, String url, byte[] payload, Map<String, String> headers, Proxy proxy) throws IOException {
		HttpURLConnection conn = createConnection(url, proxy);
		conn.setRequestMethod(method);
