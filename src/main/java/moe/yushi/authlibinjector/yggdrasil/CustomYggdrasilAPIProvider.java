...
public class CustomYggdrasilAPIProvider implements YggdrasilAPIProvider {
	...
	private boolean supportsFriends;

	public CustomYggdrasilAPIProvider(APIMetadata configuration) {
		this.apiRoot = configuration.getApiRoot();
		Object friendsMeta = configuration.getMeta().get("feature.enable_friends_api");
		this.supportsFriends = Boolean.TRUE.equals(friendsMeta);
	}
	...
	@Override
	public boolean supportsFriendsApi() {
		return supportsFriends;
	}

	@Override
	public String friendsApiBase() {
		return apiRoot;
	}
